...
Es necesario notar que para la implementación de los métodos ANGM, ANGR1 y ANGR2 no es necesario calcular productos de matrix-vector adicionales. Por ejemplo: $Aq_k = \frac{1\alpha_{k-1}}{q_k-g_{k-1}}$, lo que da
\begin{equation}
